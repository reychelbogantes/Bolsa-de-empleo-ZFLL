    ...
    <div className="ii-wrap">
      ...
      <div className="ii-head">
        <div>
          ...
          <p>
            Gestiona los datos de tu institución y los usuarios administrativos.
          </p>
        </div>
      </div>
      ...
      <div className="ii-grid">
        ...
        <div className="ii-status">
          ...
          <div className="ii-statusRow">
            ...
            <span className="ii-badge verified">VERIFICADA</span>
          </div>

          <div className="ii-statusRow">
            <span>Estado</span>
            <span className="ii-active">Activo</span>
          </div>

          <div className="ii-divider" />

          <p className="ii-statusText">
            Tu cuenta ha sido verificada por el equipo administrativo de ZFLL.
            Tienes acceso completo a todas las funciones institucionales.
          </p>
        </div>
      </div>
